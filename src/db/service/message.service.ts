...
export class MessageService {
  ...
  async findAllPosts(): Promise<MessageEntity[]> { //return type 
    if (this.messageRepository.find({ relations: ['user', 'text']})) {
      return await this.messageRepository.find({ relations: ['user', 'text'] }); //If message include text
    }
    else if (this.messageRepository.find({ relations: ['user', 'image']}))
    {
      return await this.messageRepository.find({ relations: ['user', 'image']}); //If message include image
    }
